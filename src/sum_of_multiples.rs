...
pub fn sum_of_multiples(limit: u32, factors: &[u32]) -> u32 {
    ...
    match factors.len() {
        1 =>  v.retain(|&x| x as u32 % factors[0] == 0),
        2 =>  {
            if factors[1] == 0{
                v.retain(|&x| x as u32 % factors[0] == 0);
            }
            v.retain(|&x| x as u32 % factors[0] == 0 || x as u32 % factors[1] == 0);
        },
        3 =>  v.retain(|&x| x as u32 % factors[0] == 0 || x as u32 % factors[1] == 0 || x as u32 % factors[2] == 0),
        4 =>  v.retain(|&x| x as u32 % factors[0] == 0 || x as u32 % factors[1] == 0 || x as u32 % factors[2] == 0 || x as u32 % factors[3] == 0),
        5 => v.retain(|&x| x as u32 % factors[0] == 0 || x as u32 % factors[1] == 0 || x as u32 % factors[2] == 0 || x as u32 % factors[3] == 0 || x as u32 % factors[4] == 0),
        _ => ()
    }
